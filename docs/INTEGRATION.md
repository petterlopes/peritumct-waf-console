...
**Console runtime:** Rust **2.0.9** (MSRV / Docker builder **1.98.1**, GPL-3.0-or-later) — see [TOOLCHAIN.md](TOOLCHAIN.md) and [NOTICE](../NOTICE).
...
| `WAF_APP_VERSION` | `2.0.9` | Semver string paired with product (Rust console) |
