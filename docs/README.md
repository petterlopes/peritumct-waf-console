...
| [HOMOLOGATION.md](HOMOLOGATION.md) | EN | Homologated runtimes: Docker, Podman, Cilium, Kubernetes |
| [HOMOLOGATION.pt-BR.md](HOMOLOGATION.pt-BR.md) | PT-BR | Homologação (Portuguese) |
| [TOOLCHAIN.md](TOOLCHAIN.md) | EN | Rust MSRV / Docker builder pin |
| [SECURITY.md](SECURITY.md) | EN | SAST/SCA tooling |
| [../SECURITY.md](../SECURITY.md) | EN | Vulnerability reporting / supported versions |
| [../CHANGELOG.md](../CHANGELOG.md) | EN | Release history |
...
**CrowdSec engine pin:** v1.8.1 · **Console:** 2.0.7 (Rust **1.98.1**, GPL-3.0-or-later)
