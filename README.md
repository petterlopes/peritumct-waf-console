...
| | |
|--|--|
| **Console** | **2.0.8** · GPL-3.0-or-later · [NOTICE](NOTICE) |
...
- **Admin · Operator tools** — control export, CrowdSec config integrity, audit.jsonl tail (2.0.8+); Alerts `since=` allowlist (2.0.8+)
